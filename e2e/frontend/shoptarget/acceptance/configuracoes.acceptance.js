...
describe("Validar cenários de aceitação de Configurações para o cliente : DCG", () => {
    ...
    describe('Validar listagem em Configurações', () => {

        it('Cenário: Validar Colunas', () => {

            browser.get(baseUrl + 'usuarios/config');
