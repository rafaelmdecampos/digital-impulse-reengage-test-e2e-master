...
describe("Validar cenários de aceitação de Integrations Magento para o cliente : DCG", () => {
    ...
    describe('Validar listagem em Integrations Magento', () => {

        it('Cenário: Validar Colunas', () => {

            browser.get(baseUrl + 'integrations/magento');
