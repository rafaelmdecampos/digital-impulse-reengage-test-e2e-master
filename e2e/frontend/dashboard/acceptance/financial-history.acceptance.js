...
describe("Validar cenários de aceitação de Financial History para o cliente : DCG", () => {
    ...
    describe('Validar listagem em Financial History', () => {

        it('Cenário: Validar Colunas', () => {

            browser.get(baseUrl + 'financial/history');
