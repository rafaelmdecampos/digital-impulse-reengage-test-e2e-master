...
describe("Validar cenários de aceitação de Notifications Automatic para o cliente : DCG", () => {
    ...
    describe('Validar listagem em Notifications Automatic', () => {

        it('Cenário: Validar Colunas', () => {

            browser.get(baseUrl + 'notifications/automatic');
