...
describe("Validar cenários de aceitação de Shop Convert para o cliente : DCG", () => {
    ...
    describe('Validar listagem em Clientes Config', () => {

        it('Cenário: Validar Colunas', () => {

            browser.get(baseUrl + 'clientes/config');
