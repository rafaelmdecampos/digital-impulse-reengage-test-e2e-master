...
describe("Validar cenários de aceitação de Integrations Vtex para o cliente : DCG", () => {
    ...
    describe('Validar listagem em Integrations Vtex', () => {

        it('Cenário: Validar Colunas', () => {

            browser.get(baseUrl + 'integrations/vtex');
