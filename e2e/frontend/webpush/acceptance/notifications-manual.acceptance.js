...
describe("Validar cenários de aceitação de Notifications Manual para o cliente : DCG", () => {
    ...
    describe('Validar listagem em Notifications Manual', () => {

        it('Cenário: Validar Colunas', () => {

            browser.get(baseUrl + 'notifications/manual');
