...
describe("Validar cenários de aceitação de Mail NC - Campanhas (Interno)", () => {
    ...
    describe('Validar listagem em Campanhas (Interno)', () => {

        it('Cenário: Validar Colunas', () => {

            browser.get(baseUrl + 'impulse-core/campaigns/list');
